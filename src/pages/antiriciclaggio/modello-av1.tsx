                ...
                <div className="overflow-x-auto">
                  <div className="min-w-[760px]">
                    <div className="grid grid-cols-5 gap-0 border border-gray-400">
                      ...
                      <div
                        className={`h-24 border border-gray-400 bg-yellow-200 ${isActiveCell("molto", "non")}`}
                      />
                      <div
                        className={`h-24 border border-gray-400 bg-yellow-200 ${isActiveCell("molto", "poco")}`}
                      />
                      <div
                      ...
                      />
                      <div
                        className={`h-24 border border-gray-400 bg-red-400 ${isActiveCell("molto", "molto")}`}
                      />
                      ...
                      <div
                        className={`h-24 border border-gray-400 bg-green-300 ${isActiveCell("poco", "non")}`}
                      />
                      <div
                        className={`h-24 border border-gray-400 bg-yellow-200 ${isActiveCell("poco", "poco")}`}
                      />
                      <div
                        className={`h-24 border border-gray-400 bg-orange-300 ${isActiveCell(
                          "poco",
                      ...
                      />
                      <div
                        className={`h-24 border border-gray-400 bg-orange-300 ${isActiveCell("poco", "molto")}`}
                      />
                      ...
                      <div
                        className={`h-24 border border-gray-400 bg-green-300 ${isActiveCell("non", "non")}`}
                      />
                      <div
                        className={`h-24 border border-gray-400 bg-yellow-200 ${isActiveCell("non", "poco")}`}
                      />
                      <div
                        className={`h-24 border border-gray-400 bg-yellow-200 ${isActiveCell(
                          "non",
                      ...
                      />
                      <div
                        className={`h-24 border border-gray-400 bg-orange-300 ${isActiveCell("non", "molto")}`}
                      />
                    </div>
