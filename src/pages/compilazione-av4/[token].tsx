              ...
              <Card className="mt-6 border border-sky-200 bg-slate-50 shadow-sm">
                ...
                <CardContent>
                  <div className="space-y-6">
                    ...
                    <div className="flex items-center justify-between gap-3"><div className="font-semibold">Persona politicamente esposta</div><AV4HelpButton topic="ppe" /></div>
                    ...
                    <div className="flex items-center justify-between gap-3"><div className="font-semibold">PPE titolari effettivi</div><AV4HelpButton topic="ppeTitolari" /></div>
                    ...
                    <div className="flex items-center justify-between gap-3"><div className="font-semibold">Professione / attività del cliente</div><AV4HelpButton topic="attivita" /></div>
