            ...
            <Table>
              <TableHeader className="sticky top-0 z-20 bg-white">
                <TableRow>
                  ...
                  <TableHead className="min-w-[80px] text-center">Gen</TableHead>
                  <TableHead className="min-w-[80px] text-center">Feb</TableHead>
                  <TableHead className="min-w-[80px] text-center">Mar</TableHead>
                  <TableHead className="min-w-[120px] text-center">Lipe 1T</TableHead>
                  <TableHead className="min-w-[150px]">Data Invio 1T</TableHead>
                  <TableHead className="min-w-[80px] text-center">Apr</TableHead>
                  <TableHead className="min-w-[80px] text-center">Mag</TableHead>
                  <TableHead className="min-w-[80px] text-center">Giu</TableHead>
                  <TableHead className="min-w-[120px] text-center">Lipe 2T</TableHead>
                  <TableHead className="min-w-[150px]">Data Invio 2T</TableHead>
                  <TableHead className="min-w-[80px] text-center">Lug</TableHead>
                  <TableHead className="min-w-[80px] text-center">Ago</TableHead>
                  <TableHead className="min-w-[80px] text-center">Set</TableHead>
                  <TableHead className="min-w-[120px] text-center">Lipe 3T</TableHead>
                  <TableHead className="min-w-[150px]">Data Invio 3T</TableHead>
                  <TableHead className="min-w-[80px] text-center">Ott</TableHead>
                  <TableHead className="min-w-[80px] text-center">Nov</TableHead>
                  <TableHead className="min-w-[80px] text-center">Dic</TableHead>
                  <TableHead className="min-w-[120px] text-center">Lipe 4T</TableHead>
                  <TableHead className="min-w-[150px]">Data Invio 4T</TableHead>
