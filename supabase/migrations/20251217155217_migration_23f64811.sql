-- TABELLA TBScadEstero (Esterometro)
...
-- Policy RLS
CREATE POLICY "Users can view all scadenze estero" ON TBScadEstero FOR SELECT USING (true);
CREATE POLICY "Users can manage scadenze estero" ON TBScadEstero FOR ALL USING (auth.uid() IS NOT NULL);